...
--
-- Host: localhost    Database: npd_clean_no_spatial
-- ------------------------------------------------------
...
CREATE TABLE `wellbore_coordinates` (
  ...
  `wlbNsSec` decimal(13,6) NOT NULL COMMENT 'NS seconds',
  ...
  `wlbEwSec` decimal(13,6) NOT NULL COMMENT 'EW seconds',
...
CREATE TABLE `wellbore_development_all` (
  ...
  `wlbFinalVerticalDepth` decimal(13,6) DEFAULT NULL COMMENT 'Final vertical depth (TVD) [m RKB]',
...
CREATE TABLE `wellbore_exploration_all` (
  ...
  `wlbMaxInclation` decimal(13,6) DEFAULT NULL COMMENT 'Maximum inclination [°]',
  `wlbKellyBushElevation` decimal(13,6) NOT NULL COMMENT 'Kelly bushing elevation [m]',
  `wlbFinalVerticalDepth` decimal(13,6) DEFAULT NULL COMMENT 'Final vertical depth (TVD) [m RKB]',
  `wlbTotalDepth` decimal(13,6) NOT NULL COMMENT 'Total depth (MD) [m RKB]',
  `wlbWaterDepth` decimal(13,6) NOT NULL COMMENT 'Water depth [m]',
...
-- Dump completed on 2015-03-09 15:41:45
